...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        self.add_class("food", 1, "beef")
        self.add_class("food", 2, "chicken")
        self.add_class("food", 3, "daal")
        self.add_class("food", 4, "fish")
        self.add_class("food", 5, "rice")
...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    class_names = ['BG', 'beef', 'chicken', 'daal', 'fish', 'rice']
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect foods.')
